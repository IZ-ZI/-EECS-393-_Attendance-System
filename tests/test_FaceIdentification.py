...
class TestFaceIdentification(TestCase):
    ...
    photo1 = face_recognition.load_image_file("ha.png")
    photo2 = face_recognition.load_image_file("y_ha.png")
    photo3 = face_recognition.load_image_file("trump.png")
    photo4 = face_recognition.load_image_file("cwru.png")
